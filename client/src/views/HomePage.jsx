...
// ─── HomePage ─────────────────────────────────────────────────────────────────
export default function HomePage({ initialTrending, initialNewArrivals }) {
  const [trending, setTrending] = useState(initialTrending || []);
  const [newArrivals, setNewArrivals] = useState(initialNewArrivals || []);
  const [loadingTrending, setLoadingTrending] = useState(!initialTrending);
  const [loadingNew, setLoadingNew] = useState(!initialNewArrivals);
  ...
  return (
    <div className="min-h-screen bg-dark-900">
      ...
      {/* ── 6. Brand Story & SEO Narrative Section ── */}
      <section className="max-w-7xl mx-auto px-4 md:px-8 pb-20 border-t border-white/5 pt-16">
        <div className="max-w-4xl mx-auto text-white/80 font-sans text-xs md:text-sm leading-relaxed flex flex-col gap-8">
          <div className="text-center md:text-left">
            <span className="badge text-[9px] tracking-widest uppercase mb-2 inline-block">
              ✦ Luxury Brand Story
            </span>
            <h2 className="font-display font-bold text-xl md:text-3xl text-white tracking-wide mb-4">
              Welcome to Aurabella: The Ultimate Destination for Premium Women's Fashion &amp; Luxury Beauty
            </h2>
            <p className="font-sans text-[#9d8bbb]">
              Discover a universe of conscious elegance, custom apparel, high-performance skincare, and artisanal accessories. Aurabella is not just an online shopping store for women in India; it is a movement dedicated to aligning outer fashion statements with your true inner essence.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-3">
              <h3 className="font-display font-semibold text-base md:text-lg text-white border-b border-white/5 pb-2">
                Why Choose Aurabella for Women's Fashion Online?
              </h3>
              <p>
                In the modern landscape of digital retail, finding authentic premium women's fashion online can be a challenge. At Aurabella Fashion, we bridge the gap by curating collections that prioritize artisanal design, exceptional comfort, and ethical supply chains. From selecting natural, high-performance fabrics to collaborating with certified jewelry craftsmen, we guarantee that every purchase is a high-grade investment.
              </p>
              <p>
                Our collections are designed for the modern Indian woman (ages 18–45) who values self-expression, luxury aesthetics, and structural durability. Whether you are shopping for daily casual wear, corporate attire, or high-fashion statements, Aurabella offers a personalized shopping experience tailored to your styling goals.
              </p>
            </div>

            <div className="flex flex-col gap-3">
              <h3 className="font-display font-semibold text-base md:text-lg text-white border-b border-white/5 pb-2">
                Premium Women's Fashion &amp; Apparel
              </h3>
              <p>
                Experience absolute versatility with our catalog of stylish women's clothing. We offer an extensive selection of women's apparel online, including designer dresses online, casual wear for women, and party wear dresses. Each item is produced in limited numbers to protect the uniqueness of your look.
              </p>
              <p>
                From structural silhouettes to lightweight summer collections, our designer garments are created by in-house fashion professionals. We focus on premium sizing fits, ensuring that each garment aligns perfectly with your physical dynamics.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-3">
              <h3 className="font-display font-semibold text-base md:text-lg text-white border-b border-white/5 pb-2">
                The Heritage of Women's Ethnic Wear
              </h3>
              <p>
                Embrace the rich heritage of Indian cultural attire with our curated Women's Ethnic Wear. At Aurabella, we specialize in high-quality kurtis and premium sarees designed for festivals, weddings, and everyday wear. When you buy sarees online or buy kurtis online from our brand, you receive hand-woven patterns, intricate borders, and certified textiles.
              </p>
              <p>
                Our festive wear collection also features custom-fitted ethnic sets and co-ord designs that mix classic heritage motifs with contemporary cuts, presenting a unique aesthetic direction.
              </p>
            </div>

            <div className="flex flex-col gap-3">
              <h3 className="font-display font-semibold text-base md:text-lg text-white border-b border-white/5 pb-2">
                Contemporary Women's Western Wear
              </h3>
              <p>
                For styling that fits international runways and metropolitan workspaces, explore our Women's Western Wear. We host premium selections of women's tops online, luxury women's dresses, and modern co-ord sets. Whether you need a summer linen layout or structured winter wear jackets, our western collection is detailed with precision.
              </p>
              <p>
                Our denim line, featuring perfectly tailored jeans, is structured using premium stretch materials, ensuring you experience utmost comfort and a flattering silhouette all day.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="bg-white/5 border border-white/5 rounded-2xl p-5 flex flex-col gap-2">
              <h4 className="font-display font-bold text-sm text-primary-300">Fast &amp; Reliable Delivery</h4>
              <p className="text-xs text-[#9d8bbb]">
                We partner with high-tier national logistics networks to ensure your luxury box arrives safely within 2–4 business days across India's metro cities.
              </p>
            </div>
            <div className="bg-white/5 border border-white/5 rounded-2xl p-5 flex flex-col gap-2">
              <h4 className="font-display font-bold text-sm text-primary-300">Easy 30-Day Returns</h4>
              <p className="text-xs text-[#9d8bbb]">
                If your clothing or accessories do not fit your styling goals, request a return within 30 days for a swift refund or store exchange.
              </p>
            </div>
            <div className="bg-white/5 border border-white/5 rounded-2xl p-5 flex flex-col gap-2">
              <h4 className="font-display font-bold text-sm text-primary-300">100% Secure Shopping</h4>
              <p className="text-xs text-[#9d8bbb]">
                Our payment portals are fully encrypted with SSL protocol. Choose from secure credit card checkout, digital UPI transfers, or Cash on Delivery.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            <h3 className="font-display font-semibold text-base md:text-lg text-white border-b border-white/5 pb-2">
              Complete Your Aura: Luxury Footwear, Handbags &amp; Fine Jewellery
            </h3>
            <p>
              A true fashion alignment is incomplete without premium accessories. Browse our collection of fine jewellery, designer women's footwear, and premium handbags to complete your aura. Our footwear selection features high-end heels, comfortable flats, and premium sneakers. Pair them with our luxurious handbags and curated necklaces to make an indelible statement wherever you go.
            </p>
            <p className="font-serif italic text-[#9d8bbb] text-center mt-4">
              ✦ AuraBella: Curated Luxury. Exquisite Craftsmanship. Designed to Shine.
            </p>
          </div>
        </div>
      </section>
